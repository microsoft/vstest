...
{
    // Generated from Nuget.Frameworks 6.7.0.127 nuget package, 
    // you can update it by scripts/generate/update-supported-nuget.frameworks-versions.ps1
    private static readonly Dictionary<string, Framework> Mapping = new()
    {
        ...
        [".NETFramework,Version=v4.7"] = new Framework
        {
            Name = ".NETFramework,Version=v4.7",
            FrameworkName = ".NETFramework",
            Version = "4.7.0.0",
            ShortName = "net47",
        },
        [".NETFramework,Version=v4.7.1"] = new Framework
        {
            Name = ".NETFramework,Version=v4.7.1",
            FrameworkName = ".NETFramework",
            Version = "4.7.1.0",
            ShortName = "net471",
        },
        ...
        [".NETCoreApp,Version=v6.0"] = new Framework
        {
        ...
        [".NETCoreApp,Version=v7.0"] = new Framework
        {
        ...
        [".NETCoreApp,Version=v8.0"] = new Framework
        {
        ...
        [".NETCoreApp,Version=v9.0"] = new Framework
        {
        ...
        ["native,Version=v0.0"] = new Framework
        {
            Name = "native,Version=v0.0",
    ...
    private static bool TryParseCommonFramework(string frameworkString, [NotNullWhen(true)] out string? framework)
    {
        framework = null;
        ...
        switch (frameworkString)
        {
            ...
            case "net462":
                ...
                break;
            case "net47":
                framework = ".NETFramework,Version=v4.7";
                break;
            case "net471":
