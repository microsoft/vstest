...
namespace Microsoft.VisualStudio.TestPlatform.ObjectModel.Host
{
    ...
    public interface ITestRuntimeProvider
    {
        ...
        /// <summary>
        /// Gets updated paths of sources, based on RuntimeProvider, and where the test is actually deployed(Remote Scenario).
        ...
        IEnumerable<string> UpdateTestSourcesInformation(IEnumerable<string> sources);
