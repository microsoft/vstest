...
namespace Microsoft.VisualStudio.TestPlatform.CommunicationUtilities
{
    ...
    public class TestRequestHandler2 : IDisposable, ITestRequestHandler
    {
        ...
        /// </summary>
        public TestRequestHandler2() : this(new SocketClient(), JsonDataSerializer.Instance, new TestHostManagerFactory())
        {
        }

        protected TestRequestHandler2(ICommunicationClient communicationClient, IDataSerializer dataSerializer, ITestHostManagerFactory testHostManagerFactory)
        {
