...
namespace Microsoft.VisualStudio.TestPlatform.CrossPlatEngine.Execution
{
    ...
    internal class RunTestsWithSources : BaseRunTests
    {
        ...
        public RunTestsWithSources(Dictionary<string, IEnumerable<string>> adapterSourceMap, IEnumerable<string> packages, string runSettings, TestExecutionContext testExecutionContext, ITestCaseEventsHandler testCaseEventsHandler, ITestRunEventsHandler testRunEventsHandler)
            : this(adapterSourceMap, packages, runSettings, testExecutionContext, testCaseEventsHandler, testRunEventsHandler, null)
        {
        }
