...
namespace Microsoft.VisualStudio.TestPlatform.CrossPlatEngine.Discovery
{
    ...
    internal class DiscovererEnumerator
    {
        ...
        {  
            ...
            this.metricsCollector.AddMetric(UnitTestTelemetryDataConstants.TimeTakenToLoadAdaptersInSec, (sw.Elapsed.TotalMilliseconds).ToString());
            ...
            this.metricsCollector.AddMetric(UnitTestTelemetryDataConstants.NumberOfAdapterDiscoveredInTheMachine, (discovererToSourcesMap.Keys.Count()).ToString());
            ...
            foreach (var discoverer in discovererToSourcesMap.Keys)
            {
                ...
                this.metricsCollector.AddMetric(string.Format("{0},{1}", UnitTestTelemetryDataConstants.TimeTakenToDiscoverTestsByAnAdapter, discoverer.Metadata.DefaultExecutorUri), (sw.Elapsed.TotalSeconds).ToString());
                totalTimeTakenByAdapters += sw.Elapsed.TotalSeconds;
            }

            //Collecting Total Time Taken by Adapters
            this.metricsCollector.AddMetric(UnitTestTelemetryDataConstants.TimeTakenInSecByAllAdapters, totalTimeTakenByAdapters.ToString());
        }
