...
namespace Microsoft.VisualStudio.TestPlatform.CrossPlatEngine.DataCollection
{
    ...
    internal class DataCollectionTestRunEventsHandler : ITestRunEventsHandler
    {
        ...
        public void HandleTestRunComplete(TestRunCompleteEventArgs testRunCompleteArgs, TestRunChangedEventArgs lastChunkArgs, ICollection<AttachmentSet> runContextAttachments, ICollection<string> executorUris)
        {
            if (this.dataCollectionAttachmentSets != null && this.dataCollectionAttachmentSets.Any())
            {
                runContextAttachments = DataCollectionTestRunEventsHandler.GetCombinedAttachmentSets(runContextAttachments, this.dataCollectionAttachmentSets);
            }
        ...
        /// </returns>
        internal static ICollection<AttachmentSet> GetCombinedAttachmentSets(ICollection<AttachmentSet> originalAttachmentSets, ICollection<AttachmentSet> newAttachments)
        {
