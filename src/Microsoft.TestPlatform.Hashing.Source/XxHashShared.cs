...
// VENDORED FILE - DO NOT EDIT except for the adaptations listed below.
//
// Upstream repo: https://github.com/dotnet/runtime
// Upstream path: src/libraries/System.IO.Hashing/src/System/IO/Hashing/XxHashShared.cs
// Vendored via:  https://github.com/microsoft/testfx
//                src/Platform/Microsoft.Testing.Extensions.TrxReport/Hashing/XxHashShared.cs
//
// vstest adaptations (keep these minimal so future syncs stay cheap):
//   1. Explicit usings added - vstest does not enable ImplicitUsings.
//   2. The XxHash128 cref points at Microsoft.TestPlatform.Hashing.
//
// See README.md in this folder for why this is vendored rather than referenced
// via the System.IO.Hashing package.
...
#pragma warning disable RS0030 // Do not use banned APIs - Debug is okay here.

namespace System.IO.Hashing;

/// <summary>Shared implementation of the XXH3 hash algorithm for 64-bit in XxHash3 and <see cref="Microsoft.TestPlatform.Hashing.XxHash128"/> version.</summary>
#if NET
[SkipLocalsInit]
#endif
