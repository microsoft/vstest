...
namespace Microsoft.TestPlatform.Extensions.BlameDataCollector
{
    ...
    using Microsoft.TestPlatform.Extensions.BlameDataCollectors.Interfaces;

    public class ProcDumpArgsBuilder : IProcDumpArgsBuilder
    {
        /// <inheritdoc />
        public string BuildTriggerBasedProcDumpArgs(int processId, string filename, List<string> procDumpExceptionsList, bool isFullDump = false)
        {
