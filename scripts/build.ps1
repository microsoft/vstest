...
function Publish-Package {
    ...
    $testhostFullPackageDir = $(Join-Path $env:TP_OUT_DIR "$TPB_Configuration\Microsoft.TestPlatform.TestHost\$TPB_TargetFramework472\$TPB_TargetRuntime")
    ...
    Publish-PackageInternal $packageProject $TPB_TargetFramework472 $fullCLRPackage472Dir
    ...
    Publish-PackageWithRuntimeInternal $vstestConsoleProject $TPB_TargetFramework472 $TPB_ARM64_Runtime false $fullCLRPackage472Dir
    Publish-PackageWithRuntimeInternal $vstestConsoleProject $TPB_TargetFramework472 $TPB_X64_Runtime false $fullCLRPackage472Dir
    ...
    Publish-PackageInternal $settingsMigratorProject $TPB_TargetFramework472 $fullCLRPackage472Dir
    ...
    Publish-PackageWithRuntimeInternal $dataCollectorProject $TPB_TargetFramework472 $TPB_ARM64_Runtime false $fullCLRPackage472Dir
    Publish-PackageWithRuntimeInternal $dataCollectorProject $TPB_TargetFramework472 $TPB_X64_Runtime false $fullCLRPackage472Dir
    ...
    Publish-PackageInternal $testHostProject $TPB_TargetFramework472 $testhostFullPackageDir
    ...
    Publish-PackageInternal $testHostx86Project $TPB_TargetFramework472 $testhostFullPackageDir
    ...
    Publish-PackageInternal $testHostarm64Project $TPB_TargetFramework472 $testhostFullPackageDir
    ...
    New-Item -ItemType directory -Path $fullCLRPackage472Dir -Force | Out-Null
    Copy-Item $testhostFullPackageDir\* $fullCLRPackage472Dir -Force -Recurse
    ...
    Copy-Bulk -root (Join-Path $env:TP_ROOT_DIR "src\Microsoft.TestPlatform.ObjectModel\bin\$TPB_Configuration") `
        -files @{
            $TPB_TargetFramework472     = $fullCLRPackage472Dir          # net472
    ...
    $fullCLRExtensionsDir = Join-Path $fullCLRPackage472Dir $extensions_Dir
    ...
    foreach ($file in $loggers) {
        Write-Verbose "Move-Item $fullCLRPackage472Dir\$file $fullCLRExtensionsDir -Force"
        Move-Item $fullCLRPackage472Dir\$file $fullCLRExtensionsDir -Force
    ...
    if ($TPB_LocalizedBuild) {
        Move-Loc-Files $fullCLRPackage472Dir $fullCLRExtensionsDir "Microsoft.VisualStudio.TestPlatform.Extensions.Trx.TestLogger.resources.dll"
        ...
        Move-Loc-Files $fullCLRPackage472Dir $fullCLRExtensionsDir "Microsoft.VisualStudio.TestPlatform.Extensions.Html.TestLogger.resources.dll"
    ...
    $eventLogDataCollectorNetFull = Join-Path $eventLogDataCollector $TPB_TargetFramework472
    ...
    if ($TPB_LocalizedBuild) {
        Move-Loc-Files $fullCLRPackage472Dir $fullCLRExtensionsDir "Microsoft.TestPlatform.TestHostRuntimeProvider.resources.dll"
    ...
    Write-Verbose "Copy-Item $newtonsoft $fullCLRPackage472Dir -Force"
    Copy-Item $newtonsoft $fullCLRPackage472Dir -Force
    ...
    New-Item "$fullCLRPackage472Dir\TestHost" -ItemType Directory -Force | Out-Null
    $fullCLRTestHostDir = "$fullCLRPackage472Dir\TestHost"
...
function Publish-Tests {
    if ($TPB_PublishTests) {
        ...
        $fullCLRTestDir = Join-Path $env:TP_TESTARTIFACTS "$TPB_Configuration\$TPB_TargetFramework472"
        $fullCLRPerfTestAssetDir = Join-Path $env:TP_TESTARTIFACTS "$TPB_Configuration\$TPB_TargetFramework472\TestAssets\PerfAssets"
        ...
        Publish-PackageInternal $mstest10kPerfProject $TPB_TargetFramework472 $mstest10kPerfProjectDir
        ...
        Publish-PackageInternal $nunittest10kPerfProject $TPB_TargetFramework472 $nunittest10kPerfProjectDir
        ...
        Publish-PackageInternal $xunittest10kPerfProject $TPB_TargetFramework472 $xunittest10kPerfProjectDir
