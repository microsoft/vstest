...
function Publish-Package {
    ...
    $fullCLRPackage462Dir = Get-FullCLRPackageDirectory462
    $fullCLRPackage451Dir = Get-FullCLRPackageDirectory451
    ...
    Publish-PackageInternal $packageProject $TPB_TargetFramework462 $fullCLRPackage462Dir
    ...
    Publish-PackageWithRuntimeInternal $vstestConsoleProject $TPB_TargetFramework462 $TPB_ARM64_Runtime false $fullCLRPackage462Dir
    Publish-PackageWithRuntimeInternal $vstestConsoleProject $TPB_TargetFramework462 $TPB_X64_Runtime false $fullCLRPackage462Dir
    ...
    Publish-PackageInternal $settingsMigratorProject $TPB_TargetFramework462 $fullCLRPackage462Dir
    ...
    Publish-PackageWithRuntimeInternal $dataCollectorProject $TPB_TargetFramework472 $TPB_ARM64_Runtime false $fullCLRPackage462Dir
    Publish-PackageWithRuntimeInternal $dataCollectorProject $TPB_TargetFramework472 $TPB_X64_Runtime false $fullCLRPackage462Dir
    ...
    New-Item -ItemType directory -Path $fullCLRPackage462Dir -Force | Out-Null
    Copy-Item $testhostFullPackageDir\* $fullCLRPackage462Dir -Force -Recurse
    ...
    $fullCLRExtensionsDir = Join-Path $fullCLRPackage462Dir $extensions_Dir
    ...
    foreach ($file in $loggers) {
        Write-Verbose "Move-Item $fullCLRPackage462Dir\$file $fullCLRExtensionsDir -Force"
        Move-Item $fullCLRPackage462Dir\$file $fullCLRExtensionsDir -Force
    ...
    if ($TPB_LocalizedBuild) {
        Move-Loc-Files $fullCLRPackage462Dir $fullCLRExtensionsDir "Microsoft.VisualStudio.TestPlatform.Extensions.Trx.TestLogger.resources.dll"
        ...
        Move-Loc-Files $fullCLRPackage462Dir $fullCLRExtensionsDir "Microsoft.VisualStudio.TestPlatform.Extensions.Html.TestLogger.resources.dll"
    ...
    if ($TPB_LocalizedBuild) {
        Move-Loc-Files $fullCLRPackage462Dir $fullCLRExtensionsDir "Microsoft.TestPlatform.TestHostRuntimeProvider.resources.dll"
    ...
    Copy-Item $newtonsoft $fullCLRPackage462Dir -Force
    ...
    New-Item "$fullCLRPackage462Dir\TestHost" -ItemType Directory -Force | Out-Null
    $fullCLRTestHostDir = "$fullCLRPackage462Dir\TestHost"
