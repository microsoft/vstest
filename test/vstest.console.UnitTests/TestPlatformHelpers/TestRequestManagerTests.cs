    ...
    public class TestRequestManagerTests
    {
        ...
        public TestRequestManagerTests()
        {
            ...
            this.testRequestManager = new TestRequestManager(this.commandLineOptions, this.mockTestPlatform.Object,
                mockLoggerManager, testRunResultAggregator, mockTestPlatformEventSource.Object, this.mockMetricsPublisher.Object);
        ...
        public void TestRequestManagerShouldInitializeConsoleLogger()
        {
            ...
            var requestManager = new TestRequestManager(CommandLineOptions.Instance,
                ...
                this.mockMetricsPublisher.Object);
        ...
        public void DiscoverTestsShouldPublishMetrics()
        {
            ...
            // Verify.
            this.mockMetricsPublisher.Verify( mp => mp.PublishMetrics(TelemetryDataConstants.TestDiscoveryCompleteEvent, It.IsAny<IDictionary<string, string>>()));
        }
        ...
        public void RunTestsShouldPublishMetrics()
        {
           ...
           this.mockMetricsPublisher.Verify( mp => mp.PublishMetrics(TelemetryDataConstants.TestExecutionCompleteEvent, It.IsAny<IDictionary<string, string>>()));
        }
