...
namespace Microsoft.TestPlatform.VsTestConsole.TranslationLayer.UnitTests
{
    ...
    public class VsTestConsoleWrapperTests
    {
        ...
        public void RunTestsWithSourcesShouldSucceed()
        {
            ...
            this.mockRequestSender.Verify(rs => rs.StartTestRun(this.testSources, "RunSettings", It.IsAny<TestPlatformOptions>(), It.IsAny<TestSessionInfo>(), It.IsAny<ITestRunEventsHandler>()), Times.Once);
        }
        ...
        public void RunTestsWithSourcesAndCustomHostShouldSucceed()
        {
            ...
            this.mockRequestSender.Verify(rs => rs.StartTestRunWithCustomHost(this.testSources, "RunSettings", It.IsAny<TestPlatformOptions>(), It.IsAny<TestSessionInfo>(), It.IsAny<ITestRunEventsHandler>(), It.IsAny<ITestHostLauncher>()), Times.Once);
        }
        ...
        public void RunTestsWithSelectedTestsAndCustomLauncherShouldSucceed()
        {
            ...
            this.mockRequestSender.Verify(rs => rs.StartTestRunWithCustomHost(this.testCases, "RunSettings", It.IsAny<TestPlatformOptions>(), It.IsAny<TestSessionInfo>(), It.IsAny<ITestRunEventsHandler>(), It.IsAny<ITestHostLauncher>()), Times.Once);
        }
