...
// Several classes here pin the test id algorithm by setting VSTEST_DISABLE_XXHASH128_TESTCASE_ID and
// resetting the feature flag cache. Both are process wide, so a class level [DoNotParallelize]
