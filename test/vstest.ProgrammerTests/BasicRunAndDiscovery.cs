...
public class BasicRunAndDiscovery
{
    ...
    public async Task A()
    {
        ...
        var commandLineOptions = new CommandLineOptions {  IsDesignMode = true };
        ...
        new RequestResponsePair<string, FakeMessage, object>(MessageType.SessionEnd, FakeMessage.NoResponse ),
        };
