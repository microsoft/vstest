...
public class TestDiscoveryTests
{
    ...
    public async Task GivenMultipleMsTestAssembliesThatHaveTheSameArchitecture_AndHaveDifferentTargetFrameworks_AndMULTI_TFM_RUNFeatureFlagIsEnabled_WhenTestsAreRun_ThenTwoTesthostsWithTheCorrectTFMForTheDllAreUsed()
    {
        // -- arrange
        using var fixture = new Fixture(
            new FixtureOptions
    ...
    [Only]
    public async Task GivenMultipleMsTestAssembliesThatHaveTheSameArchitecture_AndHaveDifferentTargetFrameworks_AndMULTI_TFM_RUNFeatureFlagIsEnabled_WhenTestsAreDiscovered_ThenTwoTesthostsWithTheCorrectTFMForTheDllAreUsed()
    {
        EqtTrace.InitializeVerboseTrace(@"C:\temp\log.txt");
        // -- arrange
        using var fixture = new Fixture(
            new FixtureOptions
            {
