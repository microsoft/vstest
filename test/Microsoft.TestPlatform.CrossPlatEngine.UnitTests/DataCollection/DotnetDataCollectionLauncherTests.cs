...
public class DotnetDataCollectionLauncherTests
{
    ...
    public void LaunchDataCollectorShouldLaunchDataCollectorProcess()
    {
        ...
        _mockProcessHelper.Verify(x => x.LaunchProcess(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<IDictionary<string, string?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<Action<object?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<bool>()), Times.Once());
    }
    ...
    public void LaunchDataCollectorShouldAppendDoubleQuoteForDataCollectorDllPath()
    {
        ...
        _mockProcessHelper.Verify(x => x.LaunchProcess(It.IsAny<string>(), string.Format(CultureInfo.InvariantCulture, "{0} \"{1}\" {2} ", "exec", dataCollectorAssemblyPath, string.Join(" ", arguments)), It.IsAny<string>(), It.IsAny<IDictionary<string, string?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<Action<object?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<bool>()), Times.Once());
    }
    ...
    public void LaunchDataCollectorShouldLaunchDataCollectorProcessWithCurrecntWorkingDirectory()
    {
        ...
        _mockProcessHelper.Verify(x => x.LaunchProcess(It.IsAny<string>(), It.IsAny<string>(), currentWorkingDirectory, It.IsAny<IDictionary<string, string?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<Action<object?>>(), It.IsAny<Action<object?, string?>>(), It.IsAny<bool>()), Times.Once());
    }
}
