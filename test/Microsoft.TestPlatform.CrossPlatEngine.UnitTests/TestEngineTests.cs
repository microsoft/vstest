...
namespace TestPlatform.CrossPlatEngine.UnitTests
{
    ...
    public class TestEngineTests
    {
        ...
        public void GetTestSessionManagerShouldReturnAValidInstance()
        {
            ...
            Assert.IsNotNull(this.testEngine.GetTestSessionManager(
        ...
        public void GetTestSessionManagerShouldReturnNewInstance()
        {
            ...
            var testSessionManager1 = this.testEngine.GetTestSessionManager(
                this.mockRequestData.Object,
                testSessionCriteria);

            Assert.AreNotSame(
                this.testEngine.GetTestSessionManager(
                    this.mockRequestData.Object,
                    testSessionCriteria),
                testSessionManager1);
        }
        ...
        public void GetTestSessionManagerShouldReturnDefaultTestSessionManagerIfParallelDisabled()
        {
            ...
            var testSessionManager = this.testEngine.GetTestSessionManager(
                this.mockRequestData.Object,
                testSessionCriteria);
        ...
        public void GetTestSessionManagerShouldReturnNullWhenTargetFrameworkIsNetFramework()
        {
            ...
            Assert.IsNull(this.testEngine.GetTestSessionManager(
                this.mockRequestData.Object,
                testSessionCriteria));
        }
