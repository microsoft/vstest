...
public class ExecutionTests : IntegrationTestBase
{
    ...
    {
        InvokeVsTestForExecution(GetSampleTestDll(), GetTestAdapterPath(), ".NETFramework,Version=v4.5.1");
    ...
    public void RunSelectedTests()
    {
        ...
        var arguments = PrepareArguments(GetSampleTestDll(), GetTestAdapterPath(), string.Empty, ".NETFramework,Version=v4.5.1", resultsDirectory: resultsDir.Path);
