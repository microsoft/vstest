...
namespace Microsoft.TestPlatform.SmokeTests
{
    ...
    public class ExecutionTests : IntegrationTestBase
    {
        ...
        {
            this.InvokeVsTestForExecution(this.GetSampleTestAssembly(), this.GetTestAdapterPath(), ".NETFramework,Version=v4.7.2");
        ...
        {
            var arguments = PrepareArguments(this.GetSampleTestAssembly(), this.GetTestAdapterPath(), string.Empty, ".NETFramework,Version=v4.7.2");
