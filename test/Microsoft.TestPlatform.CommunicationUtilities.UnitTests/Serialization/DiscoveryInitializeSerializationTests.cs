...
/// <summary>
/// Wire-format tests for <see cref="MessageType.DiscoveryInitialize"/> ("TestDiscovery.Initialize").
///
/// This message is sent by the runner to the test host at the start of a discovery session to
...
public class DiscoveryInitializeSerializationTests
{
    // ── Example payload ──────────────────────────────────────────────────
    ...
    public void SerializePayloadV1()
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.DiscoveryInitialize, Payload, version: 1);
    ...
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.DiscoveryInitialize, Payload, version: 7);
    ...
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.DiscoveryInitialize, Payload, version);
