...
/// <summary>
/// Original Newtonsoft-based TestResultConverter (v1 protocol), extracted from main for comparison testing.
/// </summary>
internal class NewtonsoftTestResultConverter : JsonConverter
{
    /// <inheritdoc/>
