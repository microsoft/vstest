...
/// <summary>
/// Original Newtonsoft-based TestCaseConverter (v1 protocol), extracted from main for comparison testing.
/// </summary>
internal class NewtonsoftTestCaseConverter : JsonConverter
{
    /// <inheritdoc/>
    ...
    public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
    {
        ...
        foreach (var property in properties.Values<JToken>())
        {
            ...
            {
                case "TestCase.Id":
                    testCase.Id = Guid.Parse(propertyData!);
                    break;
