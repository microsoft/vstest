...
/// <summary>
/// Wire-format tests for <see cref="MessageType.ExtensionsInitialize"/> ("Extensions.Initialize").
///
/// This message is sent by the runner to supply shared extension assembly paths.
/// The payload is an IEnumerable of string.
///
...
public class ExtensionsInitializeSerializationTests
{
    // ── Example payload ──────────────────────────────────────────────────
    ...
    public void SerializePayloadV1()
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.ExtensionsInitialize, Payload, version: 1);
    ...
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.ExtensionsInitialize, Payload, version: 7);
    ...
    {
        var json = JsonDataSerializer.Instance.SerializePayload(
            MessageType.ExtensionsInitialize, Payload, version);
