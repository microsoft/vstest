...
public class FrameworkTests : AcceptanceTestBase
{
    ...
    public void RunSpecificTestsShouldWorkWithFrameworkInCompatibleWarning(RunnerInfo runnerInfo)
    {
        ...
        // When this test runs it provides an incorrect desired framework for the run. E.g. the dll is actually net6.0
        // but we request to run as .NET Framework 4.0. On windows this has predictable results, for net6.0 dll we fail
        ...
        //
        // On Linux and Mac we execute only net6.0 tests, and even though we force .NET Framework, we end up running on mono
