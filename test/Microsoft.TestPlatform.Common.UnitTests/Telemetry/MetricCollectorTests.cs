...
namespace Microsoft.TestPlatform.Common.UnitTests.Telemetry
{
    ...
    public class MetricCollectorTests
    {
        ...
        {
            this.metricsCollector.Add(null, "DummyMessage");
        }
        ...
        public void MetricsShouldReturnValidMetricsIfValidItemsAreThere()
        {
            ...
            Assert.AreEqual(this.metricsCollector.Metrics().ContainsKey("DummyMessage"), true);
            Assert.AreEqual(this.metricsCollector.Metrics().ContainsKey("DummyMessage2"), true);
        }
