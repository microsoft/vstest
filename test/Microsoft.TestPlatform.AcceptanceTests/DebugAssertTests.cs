...
namespace Microsoft.TestPlatform.AcceptanceTests
{
    ...
    public class DebugAssertTests : AcceptanceTestBase
    {
        ...
        public void RunningTestWithAFailingDebugAssertDoesNotCrashTheHostingProcess(RunnerInfo runnerInfo)
        {
            ...
            StringAssert.Contains(this.StdOut, "Test method CrashingOnDebugAssertTestProject.DebugTests.DebugAssert threw exception: Microsoft.VisualStudio.TestPlatform.TestHost.DebugAssertException: Method Debug.Assert failed");
        }
    }
}