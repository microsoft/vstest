...
namespace Microsoft.TestPlatform.AcceptanceTests
{
    ...
    public class ExecutionTests : AcceptanceTestBase
    {
        ...
        {
            AcceptanceTestBase.SetTestEnvironment(this.testEnvironment, runnerInfo);
            var expectedWarningContains = @"Following DLL(s) do not match framework/platform settings. SimpleTestProject3.dll is built for Framework .NETFramework,Version=v4.7.2 and Platform X64";
            var assemblyPaths =
