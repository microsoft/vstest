...
namespace Microsoft.TestPlatform.AcceptanceTests
{
    ...
    public class ExecutionTests : AcceptanceTestBase
    {
        ...
        {
            AcceptanceTestBase.SetTestEnvironment(this.testEnvironment, runnerInfo);
            var expectedWarningContains = @"Following DLL(s) do not match current settings, which are .NETFramework, Version = v4.5.1 framework and X64 platform. SimpleTestProject3.dll is built for Framework .NETFramework,Version=v4.5.1 and Platform X64";
            var assemblyPaths =
