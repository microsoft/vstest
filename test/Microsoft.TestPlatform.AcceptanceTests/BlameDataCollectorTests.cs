...
namespace Microsoft.TestPlatform.AcceptanceTests
{
    ...
    public class BlameDataCollectorTests : AcceptanceTestBase
    {
        ...
        public void BlameDataCollectorShouldGiveCorrectTestCaseName(RunnerInfo runnerInfo)
        {
            ...
            this.VaildateOutput(workspace, "BlameUnitTestProject.UnitTest1.TestMethod2");
        }
        ...
        public void BlameDataCollectorShouldOutputDumpFile(RunnerInfo runnerInfo)
        {
            ...
            this.VaildateOutput(workspace, "SampleUnitTestProject3.UnitTest1.ExitWithStackoverFlow", validateDumpFile: true);
        }
        ...
        private void VaildateOutput(Workspace workspace, string testName, bool validateDumpFile = false)
        {
            ...
            var resultFiles = Directory.GetFiles(workspace.Path, "*", SearchOption.AllDirectories);
