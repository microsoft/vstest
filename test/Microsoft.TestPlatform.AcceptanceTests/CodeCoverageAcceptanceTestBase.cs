...
public class CodeCoverageAcceptanceTestBase : AcceptanceTestBase
{
    ...
    {
        return Path.Combine(IntegrationTestEnvironment.TestPlatformRootDirectory, "artifacts", IntegrationTestEnvironment.BuildConfiguration, "net462", "win7-x64", "Extensions");
    }
