...
namespace Microsoft.TestPlatform.Utilities.UnitTests
{
    ...
    public class CodeCoverageRunSettingsProcessorTests
    {
        ...
        {
            this.processor = new CodeCoverageRunSettingsProcessor();
            this.document = new XmlDocument();

            this.document.LoadXml(CodeCoverageRunSettingsProcessorTests.DefaultSettings);
        }
        ...
        public void MissingCodeCoverageTagShouldAddDefaultTag()
        {
            ...
            string expected = $"{this.document.OuterXml}";
        ...
        public void EmptyCodeCoverageTagShouldAddDefaultTag()
        {
            ...
            var codeCoverageNodes = this.ExtractNodes(processedNode, this.document.DocumentElement, "./CodeCoverage");
