...
#pragma warning disable SA1600
    ...
    public class DefaultTestHostManagerTests
    {
        ...
        public void GetTestPlatformExtensionsShouldIncludeOutputDirectoryExtensionsIfTestAdapterPathIsNotSet()
        {
            ...
            this.mockMessageLogger.Verify(ml => ml.SendMessage(TestMessageLevel.Warning, "Multiple versions of same extension found. Selecting the highest version." + Environment.NewLine + "  ext1.TestAdapter : 2.2" + Environment.NewLine + "  ext2.TestAdapter : 5.5"), Times.Once);
        }
